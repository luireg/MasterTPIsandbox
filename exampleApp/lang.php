...
$string['trad03Greeting'] =	'Welcome to the translator work $a->numTrad published at $a->time';
$string['trad03Author'] = 'This text has been written by Youssou Ndiaye';
$string['trad03FormatDate'] = 'Today is ".strftime("%A ,%d %B %Y",$a->rawTime)." and the week is has started';
$string['trad03NumString'] = 'To end a sticker collection of the Spanish league costs £ $a->amount';
$string['trad03CurrencyString'] = 'Completing a league sticker collection costs ".number_format($a->amount,2)." euros.';
$string['trad03Message'] = 'It could have been done by another person, but Mr. $a->user_surname has achieved it again. Congratulations $a->user_name $a->user_surname!';
$string['Head_trad03Credits'] = '(C)".strftime("%Y")." Youssou Ndiaye';
$string['Head_trad03FlagURL'] = 'http://www.banderas-del-mundo.com/Union_Europea/UK/super/inglesa.gif';
$string['trad03ejemploUno'] = 'I have made an exam on ".strftime ("%m/%d/%Y")." in the afternoon';
$string['trad03ejemploDos'] = 'He usually goes to gym at $a->time.';
$string['trad03ejemploTres'] = 'His birthday is ".strftime("%b %d, %Y").".';
...
$string['trad04ejemploUno'] = 'Yet Mr. $a->user_surname wants to talk to me on April ".strftime("%d",$a->rawTime) .". ';
...
$string['trad07Greeting'] =	'Welcome to the translator\'s work number $a->numTrad published at $a->time.';
...
$string['trad08ejemploDos'] = '$a->user_name paid £ $a->amount to $a->user_surname in order to paint his house. He wanted a special color: blanco';
...
$string['trad09Author'] = '';
$string['trad09FormatDate'] = '';
$string['trad09NumString'] = '';
$string['trad09CurrencyString'] = '';
$string['trad09Message'] = '';
$string['Head_trad09Credits'] = '';
$string['Head_trad09FlagURL'] = '';
$string['trad09ejemploUno'] = '';
$string['trad09ejemploDos'] = '';
$string['trad09ejemploTres'] = '';

$string['trad10Greeting'] =	'Welcome to the work of the translator $a->numTrad published at $a->time';
$string['trad10Author'] = 'This text has been written by Carlos de Prado';
$string['trad10FormatDate'] = 'Today is ".strftime("%A ,%d de %B de %Y",$a->rawTime)." and the week has already started';
$string['trad10NumString'] = 'Completing a collection of cards of the Spanish league cost $a->amount £';
$string['trad10CurrencyString'] = 'Completing a collection of cards of the Spanish league cost".number_format($a->amount,2)." pounds.';
...
$string['trad11NumString'] = '';
$string['trad11CurrencyString'] = '';
$string['trad11Message'] = '';
$string['Head_trad11Credits'] = '';
$string['Head_trad11FlagURL'] = '';
$string['trad11ejemploUno'] = '';
...
$string['trad12NumString'] = '';
$string['trad12CurrencyString'] = '';
$string['trad12Message'] = '';
$string['Head_trad12Credits'] = '';
$string['Head_trad12FlagURL'] = '';
$string['trad12ejemploUno'] = '';
$string['trad12ejemploDos'] = '';
$string['trad12ejemploTres'] = '';