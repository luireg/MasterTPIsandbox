...
$string['trad2FormatDate'] = 'Today is ".strftime("%A, %d de %B de %Y",$a->rawTime)." and it is the beggining of the week.';
$string['trad2NumString'] = 'Finishing a footbal league_s picture card collection costs $a->amount £';
$string['trad2CurrencyString'] = 'Finishing a footbal league_s picture card collection costs ".number_format($a->amount,2)." pounds.';
