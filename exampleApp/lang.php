...
$string['trad1ejemploUno'] = 'Nous nous reverrons le ".strftime("%r",$a->rawTime)."';
$string['trad1ejemploDos'] = 'Je doit être au travail aujourd´hui à ".strftime("%I:%M:%S %p",$a->rawTime).';
