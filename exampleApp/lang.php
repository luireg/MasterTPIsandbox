...
$string['trad04CurrencyString'] = 'Completing a league sticker collection costs ".number_format($a->amount,2)." €.';
...
$string['trad04ejemploDos'] = 'The soccer match will be ".strftime("%Y",$a->rawTime)."  ';
